    ...
    <footer className="bg-yoga-brown text-white py-16">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/80 mb-6 max-w-md">
              Ein authentischer Ansatz zum Yoga, der auf das Erwecken innerer Kraft
              und spiritueller Verbindung durch traditionelle Praktiken fokussiert.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors duration-300" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors duration-300" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-colors duration-300" aria-label="YouTube">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Contact info */}
          <div>
            <h3 className="text-lg font-medium mb-4 uppercase tracking-wider">Kontakt Info</h3>
            <ul className="space-y-2 text-white/80">
              <li className="flex items-start">
                ...
                <span>Rosenstraße 12<br />80331 München, Deutschland</span>
              </li>
        ...
        <div className="border-t border-white/20 pt-8 pb-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h3 className="text-lg font-medium mb-2">Newsletter anmelden</h3>
              <p className="text-white/80 text-sm">Bleibe informiert über neue Kurse, Workshops und Retreats.</p>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/20">
          ...
          >
            <span className="mr-2 text-sm">Nach oben</span>
