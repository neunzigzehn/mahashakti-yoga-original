    ...
    <section id="about" ref={sectionRef} className="py-24 bg-black relative">
      ...
      <div className="container-custom relative">
        <div className={`text-center mb-16 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="section-title text-yoga-gold">About Nina</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h3 className="font-serif text-3xl mb-6 text-yoga-gold">My Yoga Journey</h3>
            ...
            <a href="#contact" className="yoga-button-premium bg-yoga-brown border-yoga-gold text-yoga-gold hover:bg-yoga-gold hover:text-black">Connect With Me</a>
          </div>
        </div>
        ...
        <div className={`mt-24 text-center max-w-3xl mx-auto transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h3 className="font-serif text-3xl mb-6 text-yoga-gold">My Philosophy</h3>
          <div className="w-16 h-0.5 bg-yoga-gold mx-auto mb-8"></div>
          <p className="text-white/80 mb-10 leading-relaxed italic font-serif text-2xl">
            "Yoga is not about touching your toes, it's about what you learn on the way down."
          </p>
          <div className="p-8 bg-black/40 backdrop-blur-sm rounded-lg shadow-sm border border-yoga-gold/20">
