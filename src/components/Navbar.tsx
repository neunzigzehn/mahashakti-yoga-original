                  ...
                  <ul className="grid w-[250px] gap-1 p-2">
                    <li>
                      <NavigationMenuLink asChild>
                        <Link to="/angebot" className="block w-full px-4 py-2.5 rounded-md text-yoga-brown hover:bg-yoga-gold/20 hover:text-yoga-brown transition-colors">
                          Kursangebot
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        <Link to="/stundenplan" className="block w-full px-4 py-2.5 rounded-md text-yoga-brown hover:bg-yoga-gold/20 hover:text-yoga-brown transition-colors">
                          Stundenplan
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        <Link to="/retreats" className="block w-full px-4 py-2.5 rounded-md text-yoga-brown hover:bg-yoga-gold/20 hover:text-yoga-brown transition-colors">
                          Retreats
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        <Link to="/ausbildungen" className="block w-full px-4 py-2.5 rounded-md text-yoga-brown hover:bg-yoga-gold/20 hover:text-yoga-brown transition-colors">
                          Ausbildungen
                        </Link>
                      </NavigationMenuLink>
                    </li>
                    <li>
                      <NavigationMenuLink asChild>
                        <Link to="/workshops" className="block w-full px-4 py-2.5 rounded-md text-yoga-brown hover:bg-yoga-gold/20 hover:text-yoga-brown transition-colors">
                          Workshops & Events
                        </Link>
                      </NavigationMenuLink>
                    </li>
